...
type StudentsServiceClient interface {
	GetStudents(ctx context.Context, in *GetStudentsRequest, opts ...grpc.CallOption) (*StudentsResponse, error)
...
func (c *studentsServiceClient) GetStudents(ctx context.Context, in *GetStudentsRequest, opts ...grpc.CallOption) (*StudentsResponse, error) {
...
type StudentsServiceServer interface {
	GetStudents(context.Context, *GetStudentsRequest) (*StudentsResponse, error)
...
func (UnimplementedStudentsServiceServer) GetStudents(context.Context, *GetStudentsRequest) (*StudentsResponse, error) {
