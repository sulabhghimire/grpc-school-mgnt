...
type TeachersServiceClient interface {
	GetTeachers(ctx context.Context, in *GetTeachersRequest, opts ...grpc.CallOption) (*TeachersResponse, error)
...
func (c *teachersServiceClient) GetTeachers(ctx context.Context, in *GetTeachersRequest, opts ...grpc.CallOption) (*TeachersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TeachersResponse)
...
type TeachersServiceServer interface {
	GetTeachers(context.Context, *GetTeachersRequest) (*TeachersResponse, error)
...
func (UnimplementedTeachersServiceServer) GetTeachers(context.Context, *GetTeachersRequest) (*TeachersResponse, error) {
